...
# Create a button
button1= Button(root,text ="show details", command= sd)
button1.pack()

button1.configure(width = 20 , activebackground = "#9EC6EE", relief= FLAT)
button1_window = canvas.create_window(200, 235, anchor=CENTER, window=button1)
label_id_window = canvas.create_window(80, 60, anchor=CENTER, window=l1)
label_name_window = canvas.create_window(100, 100, anchor=CENTER, window=l2)
label_dob_window = canvas.create_window(140, 120, anchor=CENTER, window=l3)
label_pin_window = canvas.create_window(85, 140, anchor=CENTER, window=l4)
label_address_window = canvas.create_window(130, 160, anchor=CENTER, window=l5)
label_vehicle_no_window = canvas.create_window(335, 180, anchor=CENTER, window=l6)
canvas.pack()
